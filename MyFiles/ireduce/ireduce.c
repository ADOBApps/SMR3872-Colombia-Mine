/**
 * @author RookieHPC
 * @brief Original source code at https://rookiehpc.org/mpi/docs/mpi_ireduce/index.html
 **/
...
int main(int argc, char* argv[])
{
    ...
    int aument_rank = my_rank + 1;
    MPI_Request request;
    MPI_Ireduce(&aument_rank, &reduction_result, 1, MPI_INT, MPI_PROD, root_rank, MPI_COMM_WORLD, &request);
